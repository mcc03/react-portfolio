...
const About = () => {
    ...
    <div class="container mx-auto pt-10 pb-72">
        <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
            <div class="col-span-4 sm:col-span-3">
                <div class="bg-slate-50 shadow rounded-lg p-6">
                    <div class="flex flex-col items-center">
                        <img src="https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_1280.png" class="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0">

                        </img>
                        <h1 class="text-xl font-bold text-black">Marlon Carney Crowe</h1>
                        <p class="text-gray-700">Creative Computing Student</p>
                        <div class="mt-6 flex flex-wrap gap-4 justify-center">
                            <Link to="/contact"class="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded btn">Contact</Link>
                            <a href="#" class="bg-gray-300 hover:bg-gray-400 text-gray-700 py-2 px-4 rounded btn">Resume</a>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <ul>
                            ...
                            <li class="mb-2">Bootstrap CSS</li>
                        </ul>
                    </div>
                </div>
            </div>
